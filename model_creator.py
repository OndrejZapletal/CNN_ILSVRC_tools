...
def main():
    ...
    # model_protypes.append(create_model)
...
def save_models(models):
    ...
    """
    for model in models:
        model_name = (str(uuid.uuid4())[:8]).upper()
...
def create_model(shape=(32, 32, 3), num_classes=10):
    """Creates apropriate model for the input data."""
    model = Sequential()

    model.add(Conv2D(5, (5, 5), padding='same', input_shape=shape))
